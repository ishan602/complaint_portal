          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                      <form action="send_otp.php" name="f1" method="post" onsubmit="return matchpass()">
						  ...
						  <form action="" name="f1" method="post" onsubmit="return matchpass()">
                       <div class="form-group">
                            <label for="email">Email:</label>
                            <input type="email" class="form-control" id="email" pattern="[0-9a-z0-9]+@smvdu.ac.in$" placeholder="xyz@smvdu.ac.in" name="email" value="<?php echo $email;?> "required readonly>
							  </div>
