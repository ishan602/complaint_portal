              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                    ...
                    <form action="send_otp.php" name="f1" method="POST">
						...
						<div class="form-group">
                            ...
                            <input type="number" class="form-control" id="eotp" name="eotp" required>
						</div>
                    
						
                <button type="submit" class="btn btn-primary btn-block" name="verifyotp">Verify OTP</button><hr>
