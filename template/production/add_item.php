          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                      <form method="POST" enctype="multipart/form-data" action="add_item_script.php">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="m_units">Measurement Units:</label>
                ...
                <button type="submit" class="btn btn-primary btn-block" id="submit">Submit</button>
                        <button type="reset" class="btn btn-block btn-danger">Reset</button><hr>
                    </form>
                  </div>
                </div>
              </div>
