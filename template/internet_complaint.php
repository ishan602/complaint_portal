...
$resultcomp = mysqli_num_rows(mysqli_query($con,$select));
...
$result = mysqli_query($con, $selectcompi);
$resultcompi = mysqli_num_rows($result);
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-table"></i> Inventory <span class="fa fa-chevron-down"></span></a>
                    ...
                    <li class="active"><a href="internet_complaint.php">Internet Complaints</a></li>
