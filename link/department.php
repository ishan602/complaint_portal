               ...
               <div class="row">
                 ...
                 <img src="../img/smvdulogo.png" class="" height="50px" widht="50px"/>
                   ...
                   <b>Shri Mata Vaishno Devi University</b>
                    ...
                    <center><h4>ADMINSTRATOR LOGIN</h4></center>
                <div class="form">
                    <form action="../php/department_login_script.php" method="POST">
                        ...
                        <select class="form-control" id="sel1" name="who">
                                ...
                                <option value="Network_head">Network Head</option>
                                <option value="Internet_head">Internet Head</option>
