      ...
      <ul class="nav navbar-nav">
        ...
        <div class="home_cover">
			<div class="login">
			   ...
			   <form class="form-inline" method="POST" action="../php/solve_complaint_script.php">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="sel3" name="status" required>
                           ...
                           <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="date" placeholder="Enter Date" name="doi" value="<?php echo date("Y-m-d");?>" readonly required>
                    </div> 
